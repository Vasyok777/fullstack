...
export function CircleOfferButton({ href, label }: Props) {
  return (
    ...
    >
      <div className="flex w-full h-full md:w-30 md:h-30 md:p-5 flex-col justify-center items-center gap-[4.54px] md:gap-1.25 rounded-full border border-[#D4AF37] bg-transparent group-hover:bg-[rgba(212,175,55,0.20)] transition-[background-color] duration-300">
        <svg
