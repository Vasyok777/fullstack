...
export async function Partnership() {
  ...
  return (
    <section id="partnership" className="relative overflow-hidden py-10 md:py-12.5 lg:py-27.5 bg-[#0a0a0a]">
      ...
      <Container className="relative z-10 flex flex-col items-center gap-5 md:gap-7.5 lg:gap-15">
        <p className="font-sans font-bold text-[#D9D9D9] text-[14px] leading-[130%] text-center md:font-display md:font-normal md:text-white md:text-[18px] md:leading-tight md:uppercase lg:font-sans lg:normal-case lg:font-bold lg:text-[#D9D9D9] lg:text-[20px] lg:leading-[130%] lg:max-w-253.25">
          {t("intro1")}
          {" "}
          {t("intro2")}
        </p>
